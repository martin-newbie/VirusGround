...
void Stage2InfectedBG::Init(device* pd3dDevice)
{
	D3DXCreateTextureFromFileEx(
		pd3dDevice
		, L"./Image/Stage3Infected.png"
		, D3DX_DEFAULT
		, D3DX_DEFAULT
		, 1
		, 0
...
void Stage2InfectedBG::Update()
{
}

void Stage2InfectedBG::Render(sprite* pd3dSprite)
{
	for (int y = 0; y < H2; y++)
	{
		for (int x = 0; x < W2; x++)
